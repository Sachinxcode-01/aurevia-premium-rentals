            ...
            <div className="glass-panel-gold border-gold-border rounded-xl p-8 space-y-5">
              ...
              <div className="space-y-2 pt-1">
                ...
                <a
                  ...
                  className="flex items-center gap-2.5 text-xs text-muted-gray hover:text-gold-champagne transition"
                >
                  <svg className="w-3 h-3 text-gold-champagne/60 fill-current" viewBox="0 0 24 24">
