            ...
            <div className="glass-panel-gold border-gold-border rounded-xl p-8 space-y-5">
              ...
              <div className="space-y-2 pt-1">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-xs text-muted-gray hover:text-pink-400 transition"
                >
                  <svg className="w-3.5 h-3.5 text-gold-champagne hover:text-pink-400 fill-current shrink-0" viewBox="0 0 24 24">
            ...
            <div className="glass-panel border-white/5 rounded-xl p-8 space-y-5">
              ...
              <div className="space-y-2 pt-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 text-xs text-muted-gray hover:text-ivory/70 transition"
                >
                  <svg className="w-3 h-3 text-muted-gray/50 fill-current" viewBox="0 0 24 24">
