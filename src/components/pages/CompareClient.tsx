...
import { ArrowLeft, ShoppingCart, RefreshCw, X } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-10">
        ...
        {!loading && products.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="glass-panel border-gold-champagne/20 p-5 rounded-lg flex flex-col justify-between bg-gold-champagne/5">
              <div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
            ...
            <div className="hidden md:flex flex-col justify-end pb-4 font-mono text-[10px] text-muted-gray uppercase tracking-widest space-y-6">
              <div className="h-70 flex items-end pb-8 border-b border-white/5 font-semibold text-xs text-gold-champagne">
                Core Metrics
              </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-6">
                    {/* Image and Header */}
                    <div className="h-70 flex flex-col justify-between border-b border-white/5 pb-6">
                      <div className="h-36 overflow-hidden rounded bg-black/30 border border-white/5 flex items-center justify-center mb-4 relative">
                        <Image src={product.imagePrimary} fill sizes="300px" className="object-cover" alt={product.name} />
                      </div>
                      <div className="space-y-1">
