...
const INITIAL_REVIEWS: CustomerReview[] = [
  ...
  },
  {
    ...
    customerEmail: "spammer@temp.com",
    productName: "Sony FX6 Cinema Line Camera",
    rating: 1,
    title: "Bad service test",
    comment: "This is a test spam review submission.",
    status: "rejected",
    verifiedRental: false,
    createdAt: "2026-08-07T12:00:00Z",
    adminNote: "Flagged as automated spam.",
  },
];
...
const INITIAL_ENQUIRIES: OnlineEnquiry[] = [
  ...
  {
    id: "enq-103",
    referenceNo: "ENQ-7620",
    customerName: "Amitabh Sen",
    customerEmail: "amitabh.sen@indiefilms.net",
    customerPhone: "+91 98111 22334",
    subject: "Student Discount & Identity Verification Process",
    equipmentInterest: "Blackmagic Pocket Cinema Camera 6K Pro",
    rentalDates: "Aug 20, 2026 - Aug 22, 2026",
    message: "Hello team, I am a film school student submitting a final diploma project. Do you offer student discounts or deposit waiver with college ID proof?",
    status: "resolved",
    priority: "low",
    ...
    responses: [
      {
        id: "resp-2",
        responseText: "Dear Amitabh, We offer a 15% discount for film school students with valid ID. You can apply coupon code AUREVIASTUDENT at checkout after completing student KYC verification.",
        sentAt: "2026-08-10T11:45:00Z",
        respondedBy: "AUREVIA Admin",
      },
    ],
  },
];
...
const INITIAL_TICKETS: SupportTicket[] = [
  ...
  },
  {
    ...
    customerEmail: "deepak.v@creativemedia.com",
    bookingReference: "AV-2026-72109",
    category: "Equipment Technical Issue",
    subject: "Aputure 600d Pro light modifier adapter ring guidance",
    ...
    messages: [
      {
        ...
        text: "Hello, we are on location setup. The Bowens mount adapter ring for the Softbox seems stiff. Is there a lock latch button we should press?",
        sentAt: "2026-08-11T14:00:00Z",
      },
      {
        id: "msg-3",
        sender: "admin",
        senderName: "AUREVIA Technical Support",
        text: "Hi Deepak, Yes, pull back the silver pin latch on the top right collar of the Bowens ring, rotate counter-clockwise 15 degrees, and it will snap smoothly into place. Let us know if you need video assist!",
        sentAt: "2026-08-11T14:45:00Z",
      },
    ],
  },
  {
    ...
    customerEmail: "meera.k@weddings.in",
    bookingReference: "AV-2026-55102",
    category: "Delivery & Pickup",
    subject: "Pickup OTP code verification at Bangalore counter",
    status: "resolved",
    priority: "low",
    ...
    messages: [
      {
        ...
        text: "Hi, I am outside your Indira Nagar concierge hub. Where do I present my OTP code?",
        sentAt: "2026-08-09T08:20:00Z",
      },
      {
        id: "msg-5",
        sender: "admin",
        senderName: "AUREVIA Concierge",
        text: "Hi Meera, Please walk right into Counter 2. Staff member Aswin is ready to verify your OTP and hand over the Pelican case.",
        sentAt: "2026-08-09T08:50:00Z",
      },
    ],
  },
];
...
class EngagementStore {
  ...
  public addReview(review: Omit<CustomerReview, "id" | "createdAt" | "status">): CustomerReview {
    const reviews = this.getReviews();
    const newRev: CustomerReview = {
      ...review,
      id: `rev-${Date.now()}`,
      status: "pending", // Always pending moderation by default!
  ...
  public addEnquiry(enquiry: Omit<OnlineEnquiry, "id" | "referenceNo" | "createdAt" | "status" | "responses">): OnlineEnquiry {
    const enquiries = this.getEnquiries();
    const newEnq: OnlineEnquiry = {
      ...enquiry,
      id: `enq-${Date.now()}`,
      referenceNo: `ENQ-${Math.floor(1000 + Math.random() * 9000)}`,
      status: "new",
      createdAt: new Date().toISOString(),
      responses: [],
    };
